...
2. 按实际参与情况勾选本轮 1–7 位玩家，选择本人座位，点“新开一轮”。分析仅支持确实只有一位参与玩家的情形；多人桌请保留全部实际参与者。
...
- 同点值分牌请显式选择“同点值”或“同点值DAS”研究模板。旧same_rank模板保持原配对限制；其他真实桌规仍需单独确认。多人录牌不等于多人EV，`SINGLE_PLAYER_ONLY`保护保持。
