...
CAPABILITY_MATRIX = {
    ...
    "用户全屏浏览器捕获与热键验收": (UNSUPPORTED, "向导可逐步记录 F11/呼出面板/记两张牌/改错纠正/切回/中断来源；DPI与多屏未测可保留未测；记录不等于验收通过"),
    ...
    "发布冻结": (UNSUPPORTED, "需要单一干净SHA、绑定测试、范围内人工签收与发布授权；软件不得代签。相对已运送HEAD的脏工作树不能冻结"),
